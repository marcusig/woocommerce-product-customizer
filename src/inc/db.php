...
class DB { 
	...
	/**
	 * Field sanitizer (schema + walk). Lazy so add-ons can still call $db->sanitize().
	 *
	...
	public function get_menu( $id = null ) {
		return Editor_Menu::get( $id );
	}

	/**
	 * Add the import section to the menu.
	 *
	 * @param array $menu
	 * @return array
	 */
	public function add_import_section( $menu ) {
		return Editor_Menu::add_import_section( $menu );
	}
	...
	public function get_fields() {
		return $this->data_sanitizer()->get_fields();
	}
	...
	public function sanitize( $data, $the_key = '' ) {
		return $this->data_sanitizer()->sanitize( $data, $the_key );
	}
	...
	public function escape( $data, $the_key = '' ) {
		return $this->data_sanitizer()->escape( $data, $the_key );
	}

	public function esc_url( $url ) {
		return $this->data_sanitizer()->esc_url( $url );
	}

	public function sanitize_image( $image ) {
		return $this->data_sanitizer()->sanitize_image( $image );
	}
	...
	public static function sanitize_hidden_object_names_textarea( $data ) {
		return Data_Sanitizer::sanitize_hidden_object_names_textarea( $data );
	}
	...
	public static function sanitize_camera_focus_object_ids( $data ) {
		return Data_Sanitizer::sanitize_camera_focus_object_ids( $data );
	}

	/**
	 * Escape camera_focus_object_ids for output.
	 *
	 * @param mixed $data
	 * @return array
	 */
	public static function escape_camera_focus_object_ids( $data ) {
		return Data_Sanitizer::escape_camera_focus_object_ids( $data );
	}
	...
	public static function sanitize_animation_clips( $data ) {
		return Data_Sanitizer::sanitize_animation_clips( $data );
	}
	...
	public static function escape_animation_clips( $data ) {
		return Data_Sanitizer::escape_animation_clips( $data );
	}
	...
	public static function sanitize_animation_triggers( $data ) {
		return Data_Sanitizer::sanitize_animation_triggers( $data );
	}
	...
	public static function escape_animation_triggers( $data ) {
		return Data_Sanitizer::escape_animation_triggers( $data );
	}

	public function sanitize_nullable_int( $data ) {
		return $this->data_sanitizer()->sanitize_nullable_int( $data );
	}
	...
	public function sanitize_nullable_float( $data ) {
		return $this->data_sanitizer()->sanitize_nullable_float( $data );
	}

	public function esc_image( $image ) {
		return $this->data_sanitizer()->esc_image( $image );
	}

	public function escape_description( $description ) {
		return $this->data_sanitizer()->escape_description( $description );
	}

	public function sanitize_description( $description ) {
		return $this->data_sanitizer()->sanitize_description( $description );
	}

	public function sanitize_custom_html_description( $html ) {
		return $this->data_sanitizer()->sanitize_custom_html_description( $html );
	}

	public function escape_custom_html_description( $html ) {
		return $this->data_sanitizer()->escape_custom_html_description( $html );
	}
