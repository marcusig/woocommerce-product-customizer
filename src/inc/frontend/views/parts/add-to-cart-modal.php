...
<script type="text/html" id="tmpl-mkl-pc-atc-adding" data-wg-notranslate> 
	<div class="adding-to-cart--adding">
		<div class="header"><?php esc_html_e( 'Adding to the cart', 'product-configurator-for-woocommerce' ); ?> </div>
...
<script type="text/html" id="tmpl-mkl-pc-atc-added" data-wg-notranslate> 
	<div class="adding-to-cart--added has-box">
		<div class="header"><svg viewBox="0 0 300 300"><title><?php esc_html_e( 'Done!', 'product-configurator-for-woocommerce' ); ?></title><circle cx="150" cy="150" r="116.61"/><polyline points="73.61 150 129.81 206.19 223.76 112.24"/></svg></div>
		<div class="messages">{{{data.messages}}}</div>
		<div class="adding-to-cart--adding-cta">
			<button type="button" class="button continue-shopping"><?php esc_html_e( 'Continue shopping', 'product-configurator-for-woocommerce' ); ?></button>
			<span class="or"><?php esc_html_e( 'or', 'product-configurator-for-woocommerce' ); ?></span>
			<a href="<?php echo esc_url( $checkout_url ); ?>" class="button view-cart"><?php esc_html_e( 'Checkout', 'woocommerce' ); ?></a>
		</div>
...
<script type="text/html" id="tmpl-mkl-pc-atc-not-added" data-wg-notranslate> 
	<div class="adding-to-cart--not-added has-box">
		...
		<div class="adding-to-cart--adding-cta">
			<button class="button continue-shopping"><?php esc_html_e( 'Close', 'product-configurator-for-woocommerce' ); ?></button>
		</div>
	</div>
</script>