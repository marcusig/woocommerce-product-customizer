...
<script type="text/html" id="tmpl-mkl-pc-configurator-choices" data-wg-notranslate>
	<li class="layer-choices-title">
		<span>{{data.name}} <a role="button" href="#" class="close choices-close"><span class="screen-reader-text"><?php _e( 'Close the choices list', 'product-configurator-for-woocommerce' ) ?></span></a></span>
