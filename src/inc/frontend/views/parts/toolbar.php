...
<script type="text/html" id="tmpl-mkl-pc-configurator-step--previous" data-wg-notranslate>
	...
	<button type="button" aria-label="<?php echo esc_attr( $label ); ?>" class="step-previous <?php echo esc_attr( $classes ); ?>" title="<?php echo esc_attr( $label ); ?>">
		...
		<span class="screen-reader-text"><?php echo esc_html_x( 'Previous step: ', 'Screen reader text, previous step button prefix', 'product-configurator-for-woocommerce' ); ?> {{{data.name}}}</span>
...
<script type="text/html" id="tmpl-mkl-pc-configurator-step--next" data-wg-notranslate>
	<?php
		$classes = mkl_pc( 'settings' )->get_label( 'button_classes', 'primary button btn btn-primary wp-element-button' );
	...
	<button type="button" class="step-next <?php echo esc_attr( $classes ); ?>">
		...
		<span class="screen-reader-text"><?php echo esc_html_x( 'Next step: ', 'Screen reader text, next step button prefix', 'product-configurator-for-woocommerce' ); ?> {{{data.name}}}</span>
		<span><# if ( data.label ) { #>{{{data.label}}}<# } else { #><?php echo esc_html( $label ); ?><# } #></span>
