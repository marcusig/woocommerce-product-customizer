		...
		public function add_configure_button() { 
			...
			if ( mkl_pc_is_configurable( get_the_id() ) ) {
				...
				echo apply_filters(
					...
					$product
				); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Filtered HTML output; base string is escaped.
				echo apply_filters(
				...
				); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Filtered HTML output; dynamic parts are escaped and data-attrs are generated by internal helper.
			}
		}
